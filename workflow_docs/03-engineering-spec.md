...
# OPENAI_RESEARCH_MODEL=openai/gpt-5.5
# OPENAI_REWRITE_MODEL=openai/gpt-5.5
...
1. **Step 1 写作**
   ...
   - model:`OPENAI_MODEL` 或默认 `openai/gpt-5.5`
   - 输出:`step-1-draft.md`

2. **Step 2 查证**
   - prompt:`prompts/v3-research.md`
   - model:`OPENAI_RESEARCH_MODEL` 或默认 `openai/gpt-5.5`
   - 启用 `web_search`
   - 输出:`step-2-research.md`

3. **Step 3 改写**
   - prompt:`prompts/v3-rewrite.md`
   - model:`OPENAI_REWRITE_MODEL` 或默认 `openai/gpt-5.5`
